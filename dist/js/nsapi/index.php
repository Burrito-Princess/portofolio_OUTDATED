  ...
  <body >
    ...
    <div id="shortcut-button" class="flex justify-center">
      <div id="flex-container">
        <button class="stations border-4 p-3 bg-king_blue" id="" onclick="shortcut('RTD', 'Rotterdam Centraal')">
          Rotterdam Centraal
        </button>
        <button class="stations border-4 p-3 bg-king_blue" id="" onclick="shortcut('ASD', 'Amsterdam Centraal')">
          Amsterdam Centraal
        </button>
        <button class="station border-4 p-3 bg-king_blue" id="" onclick="shortcut('GVC', 'The Hague Centraal')">
          The Hague Centraal
        </button>
        <button class="stations border-4 p-3 bg-king_blue" id="" onclick="shortcut('UT', 'Utrecht Centraal')">
          Utrecht Centraal
        </button>
        <button class="stations border-4 p-3 bg-king_blue" id="" onclick="shortcut('AH', 'Arnhem Centraal')">
          Arnhem Centraal
        </button>
      </div>
    </div>
